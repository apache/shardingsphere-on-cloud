...
//+kubebuilder:rbac:groups=sphere-ex.com.sphere-ex.com,resources=proxyconfigs,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=sphere-ex.com.sphere-ex.com,resources=proxyconfigs/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=sphere-ex.com.sphere-ex.com,resources=proxyconfigs/finalizers,verbs=update
...
func (r *ProxyConfigReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&sphereexcomv1alpha1.ProxyConfig{}).
		Complete(r)
}
